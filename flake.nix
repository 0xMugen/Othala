  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        graphitePkg =
          if !allowUnfree then null
          else if builtins.hasAttr "graphite-cli" pkgs then pkgs.graphite-cli
          else if builtins.hasAttr "nodePackages" pkgs
            && builtins.hasAttr "graphite-cli" pkgs.nodePackages
          then pkgs.nodePackages.graphite-cli
          else null;
      in {
